...
def RPCHelp_cpp(w):
    ...
    for mode in modes:
        ...
        if mode != 'EModeType::MODE_CONSOLE':
            ...
            # options is not empty, output options. It's ibrio-cli -help
...
def generate_protocol_h():
    with open(protocol_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef IBRIO_RPC_AUTO_PROTOCOL_H
#define IBRIO_RPC_AUTO_PROTOCOL_H
...
#endif  // IBRIO_RPC_AUTO_PROTOCOL_H
''')
...
def generate_config_h():
    with open(config_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef IBRIO_MODE_AUTO_CONFIG_H
#define IBRIO_MODE_AUTO_CONFIG_H
...
#endif  // IBRIO_MODE_AUTO_CONFIG_H
''')
