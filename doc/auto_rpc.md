...
"encryptkey": {
    ...
    "example": [
        {
            "request": "ibrio-cli encryptkey 2e05c9ee45fdf58f7b007458298042fc3d3ad416a2f9977ace16d14164a3e882 123",
        ...
        "ibrio-cli encryptkey 2e05c9ee45fdf58f7b007458298042fc3d3ad416a2f9977ace16d14164a3e882 456 123"
    ],
    "error": [
...
#### Top level
  ...
  + fields
    ...
    "example": [
        ...
        {
            "request": "ibrio-cli addnewtemplate mint '{\"mint\": \"e8e3770e774d5ad84a8ea65ed08cc7c5c30b42e045623604d5c5c6be95afb4f9\", \"spent\": \"1z6taz5dyrv2xa11pc92y0ggbrf2wf36gbtk8wjprb96qe3kqwfm3ayc1\"}'",
...
```json
{
    "EModeType::MODE_SERVER": {                      // EModeType in src/mode/mode_type.h
        "usage": "ibrio-server (OPTIONS)", // usage info
        "desc": "Run ibrio server"         // desc info
    },
    ...
}
```
