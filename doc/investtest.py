...
def addvotetemplate(delegate, owner, cycle, nonce):
    result, error = call({
        'id': 1,
        'jsonrpc': '2.0',
        'method': 'addnewtemplate',
...
def makevotetemplate(delegate, owner, cycle, nonce):
    result, error = call({
        'id': 1,
        'jsonrpc': '2.0',
        'method': 'maketemplate',
...
def createvote(start, count):
    ...
    for nonce in range(start, start+count):
        vote_addr = addvotetemplate("20m053vhn4ygv9m8pzhevnjvtgbbqhgs66qv31ez39v9xbxvk0ynhfzer", "1j6x8vdkkbnxe8qwjggfan9c8m8zhmez7gm3pznsqxgch3eyrwxby8eda", 7, nonce)
...
def transvote(start, count):
    ...
    for nonce in range(start, start+count):
        vote_addr = makevotetemplate("20m053vhn4ygv9m8pzhevnjvtgbbqhgs66qv31ez39v9xbxvk0ynhfzer", "1j6x8vdkkbnxe8qwjggfan9c8m8zhmez7gm3pznsqxgch3eyrwxby8eda", 7, nonce)
...
sendfrom 1231kgws0rhjtfewv57jegfe5bp4dncax60szxk8f4y546jsfkap3t5ws 20m053vhn4ygv9m8pzhevnjvtgbbqhgs66qv31ez39v9xbxvk0ynhfzer 20000000
...
addnewtemplate activate '{"inviter": "1231kgws0rhjtfewv57jegfe5bp4dncax60szxk8f4y546jsfkap3t5ws", "owner": "1j6x8vdkkbnxe8qwjggfan9c8m8zhmez7gm3pznsqxgch3eyrwxby8eda"}'
activatesign 1231kgws0rhjtfewv57jegfe5bp4dncax60szxk8f4y546jsfkap3t5ws 1j6x8vdkkbnxe8qwjggfan9c8m8zhmez7gm3pznsqxgch3eyrwxby8eda
sendfrom 1231kgws0rhjtfewv57jegfe5bp4dncax60szxk8f4y546jsfkap3t5ws 21g0fvztdtadckgbmn4jcfkf1zrmzxfejrftqvhywwt8y0dvewjnsrg3c 20 -d=4bbfb5c9fbed76903ad6a11da5f0c32f07870b36ae0929bd42612422297f54f4a5dcdd7b6ca8747a3cf86ce15457ae9562ea9ffd66bbee98297ab5918dd60e04
...
sendfrom 1549pyzf8dhx7r4x40k5j80f12btkpqfprjp134bcgcrjn963nzsx57xb 20m053vhn4ygv9m8pzhevnjvtgbbqhgs66qv31ez39v9xbxvk0ynhfzer 20000000
...
sendfrom 1549pyzf8dhx7r4x40k5j80f12btkpqfprjp134bcgcrjn963nzsx57xb 21g03g6d249tmpfy32zfdp2tht9ehp6ybk3j7jw2banwe5z2bkbmz4h15 20 -d=fb0fdf4bb6e3323fd131b565c27dfd7f8158676bb8d4b47af309a8bc0ff598aaeb2b50bff26a1ace024c5dd9f5368d3ebb81b252b6afc61eb44787d030dcf900
