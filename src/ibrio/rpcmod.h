...
#ifndef IBRIO_RPCMOD_H
#define IBRIO_RPCMOD_H
...
private:
    ...
    rpc::CRPCResultPtr RPCActivateSign(rpc::CRPCParamPtr param);
    rpc::CRPCResultPtr RPCGetActivateStatus(rpc::CRPCParamPtr param);
    /* Mint */
