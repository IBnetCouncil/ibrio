...
public:
    CDestination();
    CDestination(const ibrio::crypto::CPubKey& pubkey);
    ...
    CDestination& SetPubKey(const ibrio::crypto::CPubKey& pubkey);
    bool GetPubKey(ibrio::crypto::CPubKey& pubkey) const;
    const ibrio::crypto::CPubKey GetPubKey() const;
