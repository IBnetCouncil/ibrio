...
public:
    ...
    static const CTemplatePtr CreateTemplatePtr(const ibrio::rpc::CTemplateRequest& obj, CDestination&& destInstance);
...
public:
    ...
    virtual void GetTemplateData(ibrio::rpc::CTemplateResponse& obj, CDestination&& destInstance) const = 0;
...
protected:
    ...
    virtual bool SetTemplateData(const ibrio::rpc::CTemplateRequest& obj, CDestination&& destInstance) = 0;
